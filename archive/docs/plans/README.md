...
- [CREATOR-FULL-IMPORT-20260902 UP 主全量入库与作品入口修复方案](CREATOR-FULL-IMPORT-20260902-UP主全量入库与作品入口修复方案.md)：已完成概览作品精确入口、Bilibili 封面 HTTPS 规范化和管理员当前运行期低优先级全量入库作业，并通过完整项目自检与非晋升 Windows 候选验证；
- [WIN-CANDIDATE-20260902 Windows 候选构建与验证链路收口方案](WIN-CANDIDATE-20260902-Windows候选构建与验证链路收口.md)：已完成非晋升候选入口、正式快照源码身份、全新数据根 EXE 冒烟、CI 触发与打包 DLL 搜索环境隔离；当前正式快照保持不变；
- [UP-DOWNLOAD-20260831 UP 主投稿定位与选择下载方案](UP-DOWNLOAD-20260831-UP主投稿定位与选择下载.md)：已完成管理员名称/精确 UID 定位、普通用户精确 UID/主页定位、按需续页与跨页选择、严格批量创建、设备领取事实和 SQLite v5 迁移；
- [ARCH-20260830 代码架构整理与重复实现收口方案](ARCH-20260830-代码架构整理与重复实现收口.md)：已完成四个领域 Router、单一 TaskQueue 生命周期、单一 Database 与领域 Store 组合、逐作品删除失败语义及旧重复路径退出治理；
- [GOV-20260830 项目约束、长期文档与测试体系治理方案](GOV-20260830-项目约束长期文档与测试体系治理.md)：已完成长期协作原则、轻量文档门禁、核心行为回归、CI 职责去重、临时测试隔离和脆弱结构测试退出治理；
